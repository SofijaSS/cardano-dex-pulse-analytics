...
Reconciled `7d volume` and 7-day rank remain live rolling values and follow the verified source refresh cadence. At Wednesday `08:00 Europe/Belgrade`, the current normalized 7-day value is also frozen in both ADA and USD for reporting. The weekly brief, `Previous Wed 7d`, `Wed WoW`, and weekly comparison chart use the two retained Wednesday snapshots, so presentation comparisons remain reproducible without hiding daily 7-day movement from the main table.
...
| --- | --- |
| 24h / 7d / 30d volume, previous 7d, WoW, TVL, volume/TVL, share, rank | 24h, live rolling 7d, and 30d retain the native-first reconciliation described above. Previous Wed 7d and Wed WoW use the two durable Wednesday 08:00 Europe/Belgrade snapshots. Version rows remain separate from protocol totals. |

...
| --- | --- |
| 24h / 7d / 30d volume, previous 7d, WoW, TVL, volume/TVL, share, rank | 24h, live rolling 7d, and 30d retain the native-first reconciliation described above. Previous Wed 7d and Wed WoW use the two durable Wednesday 08:00 CET snapshots. Version rows remain separate from protocol totals. |
